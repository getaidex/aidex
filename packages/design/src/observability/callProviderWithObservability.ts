 ...
 * @aidex/document's/@aidex/content's identically-named, identically-shaped
 * helper — built here on the mature shape from the start (this pack's own
 * Phase 3 upgrades all 7 AI-backed engines at once), not the inline-first
 * draft either of those packages started from.
 */
