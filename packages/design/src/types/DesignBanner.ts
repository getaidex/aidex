...
/** `platform`, when supplied, is a free-form hint (e.g. "web", "print", "instagram-story") — no closed platform enum in Phase 1. */
export interface DesignBannerRequest extends DesignBrief {
...
export type DesignBannerResult = DesignAssetResult;
